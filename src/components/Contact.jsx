...
const socialLinks = [
  {
    href: 'https://github.com/santhoshsat',
  ...
  {
    href: 'https://www.linkedin.com/in/santhosh-m-333793269/',
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  {
    href: 'https://www.instagram.com/sandy_santhosh_002?igsh=bDFrY3pmeDNtcHNh',
...
const Contact = () => {
  return (
    <section  id='contact' className="section">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
            <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                ...
                <p className="text-gray-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
                ...
                <div className="flex items-center gap-2 mt-auto">
                    {socialLinks.map(({href,icon},key)=>(
                        ...
                        href={href}
                        target='_blank' 
                        className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-gray-50/5
                        rounded-lg transition-[background-color,color] hover:bg-gray-50 hover:text-gray-950
    ...
    setTimeout(() => e.target.reset(), 100); 
        ...
        action="https://getform.io/f/allqyxza" method='POST' 
